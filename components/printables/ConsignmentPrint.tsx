    ...
    >
      <div className="text-black" style={{ fontFamily: "Arial, sans-serif" }}>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <p style={{ margin: "2px 0" }}>
                ...
                {consignment.previous_balance_qty || 0} items
              </p>
              <p style={{ margin: "2px 0" }}>
                <strong>New Items Added:</strong>{" "}
                {consignment.new_items_qty || 0} items
              </p>
            </div>
            <div>
              <p style={{ margin: "2px 0" }}>
              ...
              <p style={{ margin: "2px 0" }}>
                <strong>Items Returned:</strong> {consignment.returned_qty || 0}{" "}
                items
              </p>
            </div>
            <div>
              <p style={{ margin: "2px 0" }}>
                ...
                {consignment.current_balance_qty || 0} items
              </p>
            </div>
            <div>
              <p style={{ margin: "2px 0" }}>
                <strong>Payable to Medwise:</strong>{" "}
                {formatCurrency(consignment.balance_due || 0)}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-end" style={{ marginBottom: "20px" }}>
          ...
          >
            ...
            >
              ...
              <span>
                {formatCurrency(consignment.total_consigned_value || 0)}
              </span>
            </div>
            <div
              className="flex justify-between"
        ...
        >
          ...
          <p style={{ margin: "3px 0" }}>
            Products are consigned to the customer and remain property of the
            company until sold or returned.
          </p>
        </div>
      </div>
    </div>
