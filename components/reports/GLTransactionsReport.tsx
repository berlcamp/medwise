...
export default function GLTransactionsReport() {
  ...
  async function loadGLTransactions() {
    if (!selectedBranchId) {
  ...
  return (
    <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="flex items-center gap-1">
                    ...
                    <CardInfo
                      label="Total Sales"
                      text="Sum of the transaction totals for GL-paid transactions matching the selected filters (date range and billing agency)."
                    />
                  </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="flex items-center gap-1">
                    ...
                    <CardInfo
                      label="Transactions"
                      text="The number of GL transactions matching the selected filters."
                    />
                  </div>
                  <p className="text-2xl font-bold">
                ...
                <div>
                  <div className="flex items-center gap-1">
                    ...
                    <CardInfo
                      ...
                      text="Total Sales divided by the number of transactions — the average value per GL transaction."
                    />
                  </div>
                  <p className="text-2xl font-bold">
                    ₱
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="flex items-center gap-1">
                    ...
                    <CardInfo
                      label="Total Items"
                      text="The total quantity of items across all matching GL transactions."
                    />
                  </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">GL Transactions Report</CardTitle>
        </CardHeader>
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-500">
                No GL transactions found for selected criteria.
              </p>
            </div>
          ) : (
