...
export function ConsignmentDetailsModal({
  ...
  const handleAddItems = async () => {
    ...
    try {
      ...
      // Reload items, consignment data, and add items transactions
      const [itemsResult, consignmentResult, addItemsResult] =
        await Promise.all([
          supabase
            .from("consignment_items")
            .select(
                ...
                <>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 border-b pb-4 mb-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">
                        {format(
                          new Date(consignmentData.created_at),
                          "MMM dd, yyyy"
                        )}
                      </p>
                    </div>
